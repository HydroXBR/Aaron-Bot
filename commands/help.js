...
if (/adm|administraç(ã|a)o/i.test(message.content)) {
    ...
    try{
      ...
      message.inlineReply(`❌ | Ops, ${message.author}! Você me pediu ajuda para um comando, mas parece que o comando não existe! Verifique a ortografia e se o comando existe na lista, digitando \`${pp}help\` :wink:`)
    }
  } else {
